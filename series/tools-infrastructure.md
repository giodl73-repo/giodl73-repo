...
| [FLETCH](https://github.com/giodl73-repo/FLETCH) | Finished shared fetch/cache/bundle substrate for reproducible data acquisition, now adopted by ROUTE, BISECT, and ICELINES, including ICELINES query partition and quiver handoff reporting. |
